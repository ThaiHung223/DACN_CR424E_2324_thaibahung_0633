...
import com.example.dacn_cr424e_2324_thaibahung_0633.Adapter.IQuizClicked;
import com.example.dacn_cr424e_2324_thaibahung_0633.Adapter.QuizResultAdapter;
import com.example.dacn_cr424e_2324_thaibahung_0633.DAO.QuizDAO;
import com.example.dacn_cr424e_2324_thaibahung_0633.Model.Answer;
...
public class QuizWrongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupRadio();
        if(quizzes.size() == 0)
            setContentView(R.layout.no_quiz_wrong);
        else
            goQuiz();
    }
    private void setupElement() {
        ...
        quizzes = quizDAO.getAllExamQuizWrong();
        ...
        actionBar.setTitle("Làm câu sai");
    ...
    private void uncheckAll() {
        for(int i = 0; i < 5; i++){
            if(radioButtons.get(i).isChecked()){
                quizDAO.updateQuizWrongChooseAnswer(currentQuiz.getId(),currentAnswers.get(i).getId(),currentQuiz.getResult());
